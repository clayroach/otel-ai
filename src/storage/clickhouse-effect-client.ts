  ...
  Layer.scoped(
    ...
    Effect.gen(function* () {
      ...
      const client = createClient({
        ...
        clickhouse_settings: {
          // Optimized settings for OTLP data
          async_insert: 1,
...
export const createEffectClickHouseClient = (
  ...
  return Effect.scoped(Effect.service(EffectClickHouseClientTag).pipe(
