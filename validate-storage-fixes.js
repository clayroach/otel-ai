...
try {
  ...
  Promise.resolve().then(async () => {
    ...
    if (storage.StorageAPIClientTag && storage.ClickHouseConfigTag && storage.StorageAPIClientLayer) {
    ...
    try {
      ...
      const combinedLayer = storage.StorageAPIClientLayer.pipe(
    ...
    console.log('\n🎯 Validation Summary:')
    console.log('✅ Fixed: makeClickHouseStorage return type from any to Effect<ClickHouseStorage, StorageError>')
